package com.anspace.reviews.ui.chats;
...
import com.anspace.reviews.Adapter.UserAdapter;
import com.anspace.reviews.LoginActivity;
...
//         userType = results.getString("userType");
        ...
        ((scrollingActivity) getActivity()).getSupportActionBar().setTitle("CHATS");

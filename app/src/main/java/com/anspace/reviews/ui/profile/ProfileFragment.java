package com.anspace.reviews.ui.profile;
...
import com.anspace.reviews.EditProfileActivity;
import com.anspace.reviews.Model.Writer;
import com.anspace.reviews.Model.WriterInfo;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
      ...
      //  change_profile =root.findViewById(R.id.change_profile);
        ...
        ((scrollingActivity) getActivity()).getSupportActionBar().setTitle("PROFILE");

        context = getContext();

        if (!fuser.isAnonymous()) {
            reference = FirebaseDatabase.getInstance().getReference("Users").child(fuser.getUid());
            reference2 = FirebaseDatabase.getInstance().getReference("Info").child(fuser.getUid());
